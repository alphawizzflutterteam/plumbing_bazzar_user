  ...
  void addAddressModel() {
    for (int i = 0; i < addressList.length; i++) {
      addModel.add(RadioModel(
          ...
          add:
              "${addressList[i].address!}, ${addressList[i].area!}, ${addressList[i].name}, ${addressList[i].state!}, ${addressList[i].altMob!},${addressList[i].country!}, ${addressList[i].pincode!},${addressList[i].landmark!},",
