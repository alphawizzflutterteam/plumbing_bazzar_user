...
import 'package:Plumbingbazzar/Screen/SignUp.dart';
...
// Save to SharedPreferences
    ...
    print("fgjhdfkljhgljfjhjhjhjhjhjhjhjhflk--------------${id}");
    print("dddddddddddddddddddddddd");
    print(widget.title);
    print('PrintDatafghfghhghghghfhfggh____${CUR_USERID}_hkjgkjhgjhgkhg____');
    if (widget.title == getTranslated(context, 'SEND_OTP_TITLE')) {
      if (!error!) {
        // setSnackbar(otp.toString());
        // Fluttertoast.showToast(msg: otp.toString(),
    ...
    } else if (widget.title == 'SIGNIN_LBL' || "SIGNIN_LBL" == "SIGNIN_LBL") {
      print("dfffffffffffffffffff");
      if (!error!) {
        dynamic otp = getdata["otp"];
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(
          ...
          borderSide: BorderSide(
              color: Colors.grey.shade700), // Darker grey when focused
        ),
      ),
    );
  }
