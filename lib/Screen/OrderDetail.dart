...
/*  returnable() {
    ...
    return Card(
        ...
        child: Padding(
            ...
            child:
              ...
              //     mainAxisAlignment: MainAxisAlignment.spaceBetween,
              //     children: [
              //       Text("${getTranslated(context, 'TotalTaxAmount')!} :",
              //           style: Theme.of(context).textTheme.button!.copyWith(
              //               color: Theme.of(context).colorScheme.lightBlack2)),
  ...
  String? pDate, prDate, sDate, dDate;
  shippingDetails() {
    return Card(
        elevation: 0,
        child: Padding(
  ...
  Widget productItem(OrderItem orderItem, OrderModel model) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            // Order ID and OTP
            Text("Order ID: ${model.id}", style: TextStyle(fontWeight: FontWeight.w600)),
              ...
              children: [
                ClipRRect(
                  ...
                  child: Image.network(
                    ...
                    width: 60,
                    fit: BoxFit.cover,
                    errorBuilder: (context, _, __) => erroWidget(60),
                  ),
                ),
                SizedBox(width: 10),
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 4),
                      Text("OTP: ${orderItem.item_otp ?? '-'}",
                          style: TextStyle(fontSize: 12, color: Colors.grey[700])),
                      SizedBox(height: 4),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("Quantity: ${orderItem.qty}", style: TextStyle(fontSize: 12)),
            ...
            Container(
              ...
              child: Column(
                children: [
                  rowItem("Total Order Price", "+ ₹ ${model.subTotal}"),
                  rowItem("Delivery Charge", "+ ₹ ${model.delCharge}"),
                  rowItem("Wallet Used", "- ₹ ${model.walBal}"),
                  Divider(),
                  rowItem("Final Total via (${model.payMethod})", "+ ₹ ${model.payable}", highlight: true),
                ],
              ),
            ),
            ...
            Text("${model.address ?? 'Not Available'}", style: TextStyle(fontSize: 13)),
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                statusRow("Received", pDate ?? sDate, active: true),
                statusRow("Processed", prDate, active: orderItem.listStatus!.contains(PROCESSED)),
                statusRow("Shipped", sDate, active: orderItem.listStatus!.contains(SHIPED)),
                statusRow("Delivered", dDate, active: orderItem.listStatus!.contains(DELIVERD)),
              ],
            ),
          ],
        ),
...
// Utility row builder
  Widget rowItem(String title, String value, {bool highlight = false}) {
    return Padding(
...
// Timeline builder
  Widget statusRow(String label, String? date, {bool active = false}) {
    return Row(
      children: [
        Column(
          children: [
            Icon(Icons.radio_button_checked, color: active ? Colors.blue : Colors.grey, size: 16),
...
*//*
  ...
  Future<File> convertHtmlAndSaveLocally(String htmlContent) async {
      ...
      child: InkWell(
          ...
          onTap: () async {
            ...
            if (status == PermissionStatus.granted) {
              ...
              try {
                generatedPdfFile = await convertHtmlAndSaveLocally(widget.model!.invoice!);
    ...
    return Card(
      ...
      child: InkWell(
          ...
          onTap: () async {
           ...
           /*     var downloadsDirectory =
                    await PathProvider.downloadsDirectory;
                targetPath = downloadsDirectory!.path.toString();
