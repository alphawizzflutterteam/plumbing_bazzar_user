                              ...
                              onPressed: () {
                                setState(() {
                                  ...
                                  userNameController.text =
                                      user!.date![0].username;
                                  emailController.text = user!.date![0].email;
                                  userNumberController.text = user!.date![0].mobile;
                                  dob = user!.date![0].dob;
                                });
                              },
                              child: Text(
                           ...
                           TextButton(
                              onPressed: () async {
                                // if (dob != null) {
                                  ...
                                  // var userName = userNameController.text  ??  user!.date![0].proPic;
                                  var userName = userNameController.text.isEmpty
                                      ? user!.date![0].username
                                      : userNameController.text;
                                  var email = emailController.text.isEmpty  ?  user!.date![0].email   :  emailController.text;
                                  var mobileNumber = userNumberController.text.isEmpty ? user!.date![0].mobile : userNumberController.text;
                                  var updateDOB = dob ?? "10-7-2025";
                                  // var updateDOB = dob ?? "${date.day}-${date.month}-${date.year}";
                            ...
                            children: [
                              ...
                              TextField(
                                ...
                                decoration: InputDecoration(
                                    ...
                                    label: Text("${user!.date![0].mobile}")),
                              ),
                              TextField(
                                controller: emailController,
                                keyboardType: TextInputType.text,
                                decoration: InputDecoration(
                                    hintText: "${user!.date![0].email}",
                                    label: Text("${user!.date![0].email}")),
