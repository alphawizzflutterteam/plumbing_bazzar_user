                ...
                children: [
                  ClipRRect(
                    ...
                    child: FadeInImage(
                      ...
                      imageErrorBuilder: (context, error, stackTrace) => erroWidget(130),
                    ),
                  ),
                  Positioned(
                    top: 8,
                          ...
                          return InkWell(
                            child: Padding(
                              ...
                              child: Icon(
                                ...
                                !data.contains(model!.id)
                                    ? (Icons.favorite_border)
                                    : Icons.favorite ,color: (!data.contains(model!.id)) ? colors.primary : Colors.red,
                                size: 20,
                              ),
                            ),
                            onTap: () {
 ...
 /* Widget listItem(int index) {
  ...
  void getProduct(String top)
  {
    ...
    Map parameter = {
      ...
      TOP_RETAED: top,
      "category_slug":widget.id

    };
    print('PrintDataparameter____${parameter}_____');
    if (selId != null && selId != "") {
    ...
    apiBaseHelper.postAPICall(getProductApi, parameter).then((getdata) {
      ...
      if (!error) {
        ...
        if (_isFirstLoad) {
          ...
          print('PrintData__fdssf__${minPrice}__fghfhfhhgf___');
        /*  minPrice = "0";
          maxPrice = "0";*/
           _currentRangeValues = RangeValues(double.parse(minPrice.toString()), double.parse(maxPrice.toString()));
          _isFirstLoad = false;
        }
 ...
 */ /*   if (mounted)
  ...
  _showForm(BuildContext context) {
        ...
        Expanded(
          ...
          GridView.builder(
            ...
            gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
              ...
              mainAxisSpacing: 2,
              crossAxisSpacing: 2,
              childAspectRatio: 0.70, // Adjust for your new vertical card layout
            ),
    ...
    return     (index) {(index == productList.length && isLoadingmore)
                      ? singleItemSimmer(context)
                      : listItem(index);
    )    )*/
          // ListView.builder(
...
class ProductList1 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => StateProduct1();
}

class StateProduct1 extends State<ProductList1> with TickerProviderStateMixin {
  bool _isLoading = true, _isProgress = false;
  final GlobalKey<ScaffoldState> _scaffoldKey = new GlobalKey<ScaffoldState>();
  List<Product> productList = [];
  List<Product> tempList = [];
      ...
      children: [
       /* ClipRRect(
          ...
          child: CachedNetworkImage(
            ...
            height: 30,
            fit: BoxFit.cover,
            placeholder: (context, url) => Container(z
              width: double.infinity,
              height: 30,
 ...
 /* Widget listItem(int index) {
  ...
  void getProduct(String top)
  {
    ...
    apiBaseHelper.postAPICall(getProductApi1, parameter).then((getdata) {
        ...
        Expanded(
          ...
          GridView.builder(
            ...
            gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
              ...
              mainAxisSpacing: 2,
              crossAxisSpacing: 2,
              childAspectRatio: 0.60, // Adjust for your new vertical card layout
            ),
            itemCount: (offset < total)
                ? productList.length + 1
                : productList.length,
