...
class StatePayment extends State<Payment> with TickerProviderStateMixin {
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          /*   ListView.builder(
                                              ...
                                              itemBuilder: (context, index) {
                                                print("rrrrrrrrrrrrrrrrrrrrrrrrrrrrr${paymentMethodList.length}");
                                                if (index == 1 && cod)
  ...
  Future<void> _getdateTime() async {
    ...
    if (_isNetworkAvail) {
      timeSlotList.clear();
      try {
        var parameter = {TYPE: PAYMENT_METHOD, USER_ID: curUserId};
        Response response =
        ...
        if (response.statusCode == 200) {
          ...
          if (!error) {
            ...
            print('PPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPPrintData____${paymentMethodList.length}_____');
          } else {
            // setSnackbar(msg);
          }
        }
