          ...
          children: [
            ...
            GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                double price = double.parse(item.prVarientList![0].disPrice!);
                double oldPrice = double.parse(item.prVarientList![0].price!);
                double off = oldPrice != 0 ? ((oldPrice - price) / oldPrice) * 100 : 0;
...
,
  ...
  Future _getFav() async {
    ...
    if (_isNetworkAvail) {
      ...
      print('PrintDhjvjvjhvjhvjhvhjjhvjhvata____${curUserId}_____');
      if (curUserId != null) {
        Map parameter = {
          USER_ID: curUserId,
        };
