...
import 'package:Plumbingbazzar/Model/User.dart';
...
class SectionModel {
  ...
  SectionModel(
      {this.id,
        this.title,
        this.shortDesc,
        this.productList,this.cod_policy,
        this.varientId,
        this.qty,
        this.productId,
        this.perItemTotal,
  ...
  factory SectionModel.fromJson(Map<String, dynamic> parsedJson) {
    ...
    return SectionModel(
        ...
        cod_policy: parsedJson['cod_policy'],
...
class Product {
  ...
  int? minOrderQuntity;
  String? isFav,
      isReturnable,cod_policy,terms_n_condition,
      isCancelable,
      isPurchased,
      availability,
      madein,
  ...
  Product(
      {this.id,
        ...
        this.isFav,
        this.isCancelable,
        this.isReturnable,this.cod_policy,this.terms_n_condition,
        this.isPurchased,
        this.availability,
        this.noOfRating,
        this.attrIds,
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    ...
    return new Product(
      ...
      cod_policy: json["cod_policy"],
      terms_n_condition: json["terms_n_condition"],
