...
import 'package:Plumbingbazzar/Screen/Favorite.dart';
import 'package:Plumbingbazzar/Screen/Login.dart';
import 'package:Plumbingbazzar/Screen/Search.dart';
...
/*Future<bool> isNetworkAvailable() async {
  ...
  if (connectivityResult == ConnectivityResult.mobile) {
    print("check  network  true .............");
    return true;
  } else if (connectivityResult == ConnectivityResult.wifi) {
    print("check  network  false .............");
    return true;
  }
  print("false...................");
  return false;
...
back() {
  return BoxDecoration(
    gradient: LinearGradient(
        ...
        colors: [colors.lightWhite2, colors.lightWhite2],
        stops: [0, 1]),
  );
}
...
getAppBar(
  ...
  return AppBar(
    ...
    title: Text(
      title,
      style: TextStyle(color: colors.blackTemp, fontWeight: FontWeight.normal),
    ),
    actions: <Widget>[
      // IconButton(
...
Widget getNoItemState(BuildContext context) {
  return Center(child: Text(getTranslated(context, 'noItemState')!));
}

Widget getNoItemCity(BuildContext context) {
  return Center(child: Text(getTranslated(context, 'noItemCity')!));
}

Widget getNoItemTahsil(BuildContext context) {
  return Center(child: Text(getTranslated(context, 'noItemTahsil')!));
}
