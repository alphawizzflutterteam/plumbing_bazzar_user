...
extension colors on ColorScheme {
  ...
  static const Color grad1Color = Color(0xffE3000F);
  static const Color grad2Color = Color(0xffE3000F);
  static const Color lightWhite2 = Color(0xffEEF2F3);

  static const Color yellow = Color(0xfffdd901);

  static const Color red = Color(0xffE3000F);
...
class ColorResources {
  static const Color secondary = Color(0xffE9F9FF);
  static const Color buttonColor = Color(0xff01ADEF);
