...
final Uri getSliderApi = Uri.parse(baseUrl + 'get_slider_video');
...
final Uri getProductApi1 = Uri.parse(baseUrl + 'get_product_details');
final Uri manageCartApi = Uri.parse(baseUrl + 'manage_cart');
final Uri getUserLoginApi = Uri.parse(baseUrl + 'login');
final Uri getUserLoginApi1 = Uri.parse(baseUrl + 'login_with_otp');
...
final Uri getStateApi = Uri.parse(baseUrl + 'get_states');
final Uri getAreaByTahsilApi = Uri.parse(baseUrl + 'get_areas_by_city_id');
final Uri getStatesByCityApi = Uri.parse(baseUrl + 'get_city_by_state_id');
...
const String STATE_ID = 'state';
const String TEHSIL = 'tehsil';
...
const dynamic MINPRICE = 'min_price';
